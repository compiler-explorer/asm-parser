...
struct Regexes
{
    ...
    ctre::search<R"re(^\h*\.(string|asciz|ascii|base64|[1248]?byte|short|half|[dhx]?word|long|quad|octa|value|zero))re">;
    ...
    static constexpr auto pltFunction = ctre::search<R"re(^(.*@plt[\-xa-zA-Z0-9]*)$)re">;
};
